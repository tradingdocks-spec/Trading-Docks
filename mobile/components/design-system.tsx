...
const s = StyleSheet.create({
  ...
  dockSurface: { borderRadius: radius.dock, borderWidth: 1, borderColor: edge.subtle, borderTopColor: edge.highlight, backgroundColor: surface.dock, padding: space.md, gap: space.md, overflow: 'hidden', shadowColor: '#000', shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.22, shadowRadius: 14, elevation: 10 },
  ...
  dockRail: { minHeight: 46, flexDirection: 'row', alignItems: 'center', gap: 3, borderRadius: radius.control, borderWidth: 1, borderColor: edge.subtle, borderTopColor: edge.highlight, backgroundColor: surface.inset, padding: 4, shadowColor: '#000', shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.18, shadowRadius: 8, elevation: 5 },
  ...
  dockSegmentSelected: { backgroundColor: color.primary + '28', borderWidth: 1, borderColor: edge.active, borderTopColor: edge.highlight },
  dockActionProminent: { minHeight: 52, backgroundColor: color.primary, borderWidth: 1, borderColor: color.primaryBright, borderTopColor: edge.highlight, shadowColor: color.primaryBright, shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.16, shadowRadius: 8, elevation: 6 },
  ...
  button: { minHeight: 48, borderRadius: radius.md, borderWidth: 1, borderTopColor: edge.highlight, alignItems: 'center', justifyContent: 'center', flexDirection: 'row', gap: space.xs, shadowColor: '#000', shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.18, shadowRadius: 8, elevation: 5 },
