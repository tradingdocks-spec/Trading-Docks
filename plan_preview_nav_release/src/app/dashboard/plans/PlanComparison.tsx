...
const plans: Plan[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "Unlimited decks and collections",
...
const comparisonRows = [
  { label: "Inventory access", values: ["—", "Personal", "Seller operations", "Full command center"] },
  { label: "Inventory units", values: ["—", "5,000", "50,000", "250,000"] },
  { label: "Storage locations", values: ["—", "25", "Unlimited", "Unlimited"] },
