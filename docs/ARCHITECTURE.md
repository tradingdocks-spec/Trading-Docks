...
- Planned: Add external provider-backed archetype/template sources, saved proposal persistence, apply/revert workflows against Deck Vault, combo provider activation, and richer price/provider coverage after the deterministic recommendation layer is reviewed.
