...
- Partially Implemented: Rapid Scan has source-tested throughput contracts and live-frame state handling, but continuous identity still needs native frame-title OCR and physical benchmark evidence before it can replace still-photo Precision capture.
