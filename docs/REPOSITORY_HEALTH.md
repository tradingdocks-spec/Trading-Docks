...
- Implemented: The active Scan tab now uses a premium camera-first hierarchy with compact two-line header, large guide viewport, exactly three primary controls, compact result tray, secondary settings/manual/diagnostics panels, and bottom session strip.
