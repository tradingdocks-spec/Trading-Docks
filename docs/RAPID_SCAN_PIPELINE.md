...
- Partially Implemented: Rapid Scan services remain source-tested experimental architecture, but they are not active in the production scanner route. Production Auto Scan ON and OFF both invoke the shared still-capture OCR pipeline.
