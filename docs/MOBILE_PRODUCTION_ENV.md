...
- Partially Implemented: Strict production Supabase env validation runs when `NODE_ENV=production`; CI/staging should provide production-style public env values for that check.
