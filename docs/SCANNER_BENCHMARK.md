...
- Implemented: Rapid Scan benchmark export now includes live OCR frames sampled, OCR start/end counts, skipped frames, stale discards, last OCR duration, local match duration, identity latency, and frame-to-result latency.
