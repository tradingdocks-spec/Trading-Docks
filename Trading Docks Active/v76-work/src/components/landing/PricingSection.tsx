    ...
    >
      <div className="mx-auto max-w-3xl text-center">
        ...
        <p className="mt-5 text-base leading-7 text-[#8296aa]">
          Compare plans for personal collections, online selling, and full store operations.
        </p>
      </div>
        ...
        <div className="relative p-7 sm:p-10">
          <div className="relative flex flex-col gap-8 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-2 text-sm text-[#8296aa]">No credit card required.</p>
            </div>
          ...
          <div className="relative mt-8 grid gap-3 border-t border-white/[0.06] pt-7 sm:grid-cols-3">
            {["500 inventory units", "10 saved decks", "Basic market lookups"].map((label) => (
