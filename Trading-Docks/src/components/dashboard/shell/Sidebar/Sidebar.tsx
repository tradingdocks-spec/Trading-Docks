    ...
    <>
      ...
      >
                  ...
                  return (
                    <Link
                      ...
                      className={[
                        ...
                        active
                          ? "border-cyan-300/[0.2] bg-cyan-400/[0.07] text-white shadow-[0_0_28px_rgba(34,211,238,0.055),inset_0_1px_rgba(255,255,255,0.025)]"
                    ...
                    >
                      {active ? (
                        <>
                          ...
                          <span className="absolute left-0 top-1/2 h-8 w-20 -translate-y-1/2 rounded-full bg-cyan-400/[0.08] blur-xl" />
                        </>
                      ) : null}
        ...
        <div className="relative border-t border-white/[0.055] p-3">
          ...
          >
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-cyan-300/20 bg-cyan-400/[0.08] text-xs font-semibold text-cyan-200 shadow-[0_0_20px_rgba(34,211,238,0.09)]">
              JR
            </div>
