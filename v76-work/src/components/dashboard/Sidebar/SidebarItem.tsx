...
export function SidebarItem({
  ...
  return (
    ...
    >
      ...
      {collapsed ? (
        <span className="pointer-events-none absolute left-[calc(100%+12px)] z-50 whitespace-nowrap rounded-lg border border-white/[0.08] bg-[#0b141b] px-2.5 py-1.5 text-xs font-medium text-slate-200 opacity-0 shadow-2xl transition-all duration-150 group-hover:translate-x-0 group-hover:opacity-100">
          {label}
        </span>
      ) : null}
    </Link>
