export function BackgroundEffects() {
  return (
    <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden bg-[#02090f]">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_18%_8%,rgba(6,182,212,0.11),transparent_28%),radial-gradient(circle_at_82%_26%,rgba(14,116,144,0.08),transparent_30%),linear-gradient(180deg,#02090f_0%,#031019_52%,#02080d_100%)]" />
      <div
      ...
      />
      <div className="absolute left-[7%] top-20 h-[460px] w-[460px] rounded-full bg-cyan-400/[0.06] blur-[150px]" />
