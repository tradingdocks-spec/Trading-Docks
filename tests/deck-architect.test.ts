          ...
          return {
            data: [
              ...
              },
              {
                ...
                quantity: 1,
                inventory_value: 40,
                data: { inventoryValueSemantics: "total_row_v1", unitMarketValue: 37.5, typeLine: "Enchantment" },
              },
            ],
            error: null,
            count: 2,
            ...
            data: [
              {
                ...
                quantity: 4,
                inventory_value: 3,
                data: { inventoryValueSemantics: "total_row_v1", typeLine: "Instant", oracleText: "Lightning Bolt deals 3 damage to any target.", mana_cost: "{R}", color_identity: ["R"] },
              },
              {
                id: "inv-mountain",
                card_name: "Mountain",
                quantity: 20,
                inventory_value: 1,
                data: { inventoryValueSemantics: "total_row_v1", typeLine: "Basic Land - Mountain", color_identity: ["R"] },
              },
            ],
            error: null,
            count: 2,
