...
public record ScanCapabilities(int[] Dpi, string[] ColorModes, string[] Sources, bool Duplex = false, bool AutoCrop = false, bool CancelCapture = false, bool ExternalSettings = false, string? CaptureInstruction = null);
