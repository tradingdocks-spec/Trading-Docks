...
export type AutopilotPackage = { input: AutopilotInput; feature: ProductMarketingFeature; plan: ReturnType<typeof buildCampaignDraftPlan>; directions: CreativeConcept[]; recommendedDirection: CreativeConcept["id"]; copy: AutopilotCopyPackage; variants: Array<{ platform: CreativePlatform; width: number; height: number; filename: string }>; renderedVariants?: Array<{ platform: CreativePlatform; width: number; height: number; filename: string; assetId: string; previewUrl: string | null }>; source: "approved_product_metadata_and_synthetic_demo_state"; autonomousActions: string[] };
