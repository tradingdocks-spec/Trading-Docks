...
export function generateCreativeDirections(input: DirectionInput): CreativeConcept[] {
  ...
  return [
    { id: "product", direction: "product", conceptName: `${feature} / Product proof`, audienceInsight: `Operators want to see the real ${feature} workflow before they trust the claim.`, primaryMessage: description, headline: feature === "Chaos Sort" ? "Sort the chaos." : `See ${feature}.`, subheadline: feature === "Chaos Sort" ? "Turn unsorted cards into organized, trackable inventory." : description, visualStory: "Authentic Trading Docks UI is the visual hero with restrained framing and generous negative space.", compositionFamily: "product_hero", productAssetStrategy: "Use one approved primary product screenshot at the largest readable scale.", supportingAssetStrategy: "No decorative image is required; use the approved accent treatment only.", logoPlacement: "top_right", cta, brandSignatureElements: ["approved logo", "real product UI", "navy surface", "cyan CTA"] },
    { id: "transformation", direction: "transformation", conceptName: `${feature} / From problem to workflow`, audienceInsight: `${input.audience || "TCG operators"} recognize the daily problem before they recognize the feature name.`, primaryMessage: `Turn the work around ${feature.toLowerCase()} into a clear next step.`, headline: feature === "Chaos Sort" ? "Collections don't arrive organized." : `Make ${feature.toLowerCase()} easier to run.`, subheadline: feature === "Chaos Sort" ? "Move from unsorted intake to identifiable, trackable inventory." : description, visualStory: "A controlled before/after story moves from operational friction to an authentic Trading Docks workflow.", compositionFamily: "before_after", productAssetStrategy: "Use a real product screenshot on the resolved side; never fabricate the problem state as a fake UI.", supportingAssetStrategy: "Use one or two approved TCG images as supporting context with controlled crop and overlap.", logoPlacement: "bottom_left", cta, brandSignatureElements: ["product-specific copy", "before/after hierarchy", "approved TCG imagery", "signature spacing"] },
    { id: "editorial", direction: "editorial", conceptName: `${feature} / Editorial system`, audienceInsight: "A premium TCG audience responds to confident editorial restraint more than decorative novelty.", primaryMessage: `From ${feature.toLowerCase()} to a more dependable operation.`, headline: feature === "Chaos Sort" ? "From collection buy to searchable inventory." : `${feature} that feels organized.`, subheadline: description, visualStory: "Selective TCG imagery, confident typography, and a small amount of real product context create a recognizable brand composition.", compositionFamily: "editorial_tcg", productAssetStrategy: "Use a detail or workflow screenshot as proof, not as a decorative fake dashboard.", supportingAssetStrategy: "Use one hero card or a controlled two-to-three-card stack from approved assets.", logoPlacement: "footer_lockup", cta, brandSignatureElements: ["editorial typography", "selective card imagery", "real product context", "restrained composition"] },
  ];
}
