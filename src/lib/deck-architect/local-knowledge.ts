...
const COMMANDER_STRATEGY_LIBRARY: Record<string, CommanderStrategyProfile[]> = {
  ...
  [normalizeCardKey("Krenko, Mob Boss")]: [
    libraryStrategy(
      ...
      ["goblin-token-maker", "goblin-payoff", "token-generation", "haste-enabler", "sacrifice-outlet", "ramp", "card-advantage", "interaction", "protection", "finisher", "synergy"],
      [
        seed("Skirk Prospector", 1, ["ramp", "sacrifice-outlet", "synergy"], 1.5, "Creature - Goblin"),
        seed("Goblin Warchief", 1, ["ramp", "haste-enabler", "goblin-payoff", "synergy"], 1, "Creature - Goblin Warrior"),
        seed("Goblin Chieftain", 1, ["threat", "finisher", "synergy"], 8, "Creature - Goblin"),
        seed("Goblin Matron", 1, ["tutor", "goblin-payoff", "synergy"], 2, "Creature - Goblin"),
        seed("Goblin Recruiter", 1, ["tutor", "goblin-payoff", "synergy"], 6, "Creature - Goblin"),
        seed("Goblin Ringleader", 1, ["card-advantage", "goblin-payoff", "synergy"], 1, "Creature - Goblin"),
        seed("Mogg War Marshal", 1, ["goblin-token-maker", "token-generation", "synergy"], 0.3, "Creature - Goblin Warrior"),
        seed("Siege-Gang Commander", 1, ["goblin-token-maker", "token-generation", "finisher", "interaction"], 1, "Creature - Goblin"),
        seed("Conspicuous Snoop", 1, ["card-advantage", "goblin-payoff", "synergy"], 8, "Creature - Goblin Rogue"),
        seed("Krenko, Tin Street Kingpin", 1, ["goblin-token-maker", "token-generation", "synergy"], 1, "Legendary Creature - Goblin"),
        ...
        seed("Pashalik Mons", 1, ["goblin-payoff", "finisher", "synergy"], 2.5, "Legendary Creature - Goblin Warrior"),
      ],
      [
        seed("Goblin Instigator", 1, ["token-generation", "threat"], 0.2, "Creature - Goblin"),
        seed("Battle Cry Goblin", 1, ["goblin-payoff", "haste-enabler", "token-generation", "finisher"], 1, "Creature - Goblin"),
        seed("Goblin Rabblemaster", 1, ["goblin-token-maker", "token-generation", "threat"], 5, "Creature - Goblin Warrior"),
        seed("Legion Warboss", 1, ["goblin-token-maker", "token-generation", "threat"], 1.5, "Creature - Goblin Soldier"),
        seed("Krenko's Command", 1, ["goblin-token-maker", "token-generation"], 0.2, "Sorcery"),
        seed("Hordeling Outburst", 1, ["token-generation"], 0.25, "Sorcery"),
        seed("Dragon Fodder", 1, ["token-generation"], 0.15, "Sorcery"),
        seed("Squee, Dubious Monarch", 1, ["goblin-token-maker", "token-generation", "synergy"], 2, "Legendary Creature - Goblin Noble"),
        seed("Mogg Infestation", 1, ["goblin-token-maker", "token-generation", "finisher"], 3, "Sorcery"),
        seed("Goblin Trashmaster", 1, ["goblin-payoff", "artifact-interaction", "synergy"], 1, "Creature - Goblin Warrior"),
        seed("Goblin Cratermaker", 1, ["interaction", "goblin-payoff", "synergy"], 0.5, "Creature - Goblin Warrior"),
        seed("Goblin Chirurgeon", 1, ["protection", "sacrifice-outlet", "goblin-payoff"], 0.5, "Creature - Goblin Shaman"),
        seed("Arms Dealer", 1, ["interaction", "sacrifice-outlet", "goblin-payoff"], 0.5, "Creature - Goblin Rogue"),
        seed("Goblin Sharpshooter", 1, ["interaction", "finisher", "goblin-payoff"], 8, "Creature - Goblin"),
        seed("Rundvelt Hordemaster", 1, ["card-advantage", "goblin-payoff", "synergy"], 1.5, "Creature - Goblin Warrior"),
        seed("Moria Marauder", 1, ["card-advantage", "goblin-payoff", "synergy"], 1, "Creature - Goblin Warrior"),
        seed("Goblin King", 1, ["goblin-payoff", "finisher"], 1.5, "Creature - Goblin"),
        seed("Hobgoblin Bandit Lord", 1, ["goblin-payoff", "finisher", "interaction"], 0.5, "Creature - Goblin Rogue"),
        seed("Muxus, Goblin Grandee", 1, ["goblin-payoff", "card-advantage", "finisher"], 8, "Legendary Creature - Goblin Noble"),
        seed("Beetleback Chief", 1, ["goblin-token-maker", "token-generation"], 0.4, "Creature - Goblin Warrior"),
        seed("Boggart Shenanigans", 1, ["goblin-payoff", "finisher", "synergy"], 0.5, "Tribal Enchantment - Goblin"),
        seed("Purphoros, God of the Forge", 1, ["token-payoff", "finisher", "synergy"], 18, "Legendary Enchantment Creature - God"),
        seed("Witty Roastmaster", 1, ["token-payoff", "finisher", "synergy"], 0.5, "Creature - Devil Citizen"),
        seed("Torbran, Thane of Red Fell", 1, ["finisher", "burn", "synergy"], 1, "Legendary Creature - Dwarf Noble"),
        seed("Coat of Arms", 1, ["goblin-payoff", "finisher"], 16, "Artifact"),
        seed("Door of Destinies", 1, ["goblin-payoff", "finisher"], 2, "Artifact"),
        seed("Obelisk of Urd", 1, ["goblin-payoff", "finisher"], 0.5, "Artifact"),
        seed("Empty the Warrens", 1, ["goblin-token-maker", "token-generation"], 0.5, "Sorcery"),
        seed("Goblin War Party", 1, ["goblin-token-maker", "haste-enabler", "finisher"], 0.25, "Sorcery"),
        seed("Moggcatcher", 1, ["tutor", "goblin-payoff", "synergy"], 35, "Creature - Mercenary"),
        seed("Goblin Wizard", 1, ["goblin-payoff", "synergy"], 20, "Creature - Goblin Wizard"),
        seed("Brightstone Ritual", 1, ["ramp", "ritual", "synergy"], 1, "Instant"),
        seed("Battle Hymn", 1, ["ramp", "ritual", "synergy"], 0.4, "Instant"),
        seed("Ruby Medallion", 1, ["ramp", "cost-reduction"], 30, "Artifact"),
        seed("Mind Stone", 1, ["ramp", "card-advantage"], 0.5, "Artifact"),
        seed("Wayfarer's Bauble", 1, ["ramp", "land-fixing"], 0.5, "Artifact"),
        seed("Herald's Horn", 1, ["ramp", "card-advantage", "goblin-payoff"], 5, "Artifact"),
        seed("Vanquisher's Banner", 1, ["card-advantage", "goblin-payoff", "finisher"], 6, "Artifact"),
        seed("Idol of Oblivion", 1, ["card-advantage", "token-payoff"], 1, "Artifact"),
        seed("Skullclamp", 1, ["card-draw", "card-advantage"], 5, "Artifact - Equipment"),
        seed("Slate of Ancestry", 1, ["card-draw", "card-advantage"], 2, "Artifact"),
        seed("Wheel of Misfortune", 1, ["card-draw", "card-advantage", "wheel"], 5, "Sorcery"),
        seed("Chaos Warp", 1, ["interaction", "removal"], 1, "Instant"),
        seed("Abrade", 1, ["interaction", "removal", "artifact-interaction"], 0.2, "Instant"),
        seed("Vandalblast", 1, ["interaction", "artifact-interaction"], 4, "Sorcery"),
        seed("Blasphemous Act", 1, ["mass-removal", "board-wipe"], 2.5, "Sorcery"),
        seed("Lightning Bolt", 1, ["interaction", "burn"], 1, "Instant"),
        seed("Red Elemental Blast", 1, ["interaction", "countermagic"], 5, "Instant"),
        seed("Pyroblast", 1, ["interaction", "countermagic"], 5, "Instant"),
        seed("Swiftfoot Boots", 1, ["protection"], 1.25, "Artifact - Equipment"),
        seed("Lightning Greaves", 1, ["protection", "haste-enabler"], 4.5, "Artifact - Equipment"),
        seed("Fervor", 1, ["haste-enabler", "attack-support"], 5, "Enchantment"),
        seed("Mass Hysteria", 1, ["haste-enabler", "attack-support"], 6, "Enchantment"),
        seed("Thousand-Year Elixir", 1, ["haste-enabler", "untap-engine", "synergy"], 8, "Artifact"),
        seed("Magewright's Stone", 1, ["untap-engine", "synergy"], 0.5, "Artifact"),
      ],
      {
