          ...
          <aside className="space-y-4">
            <section className="rounded-[24px] border border-td-success/[0.12] bg-td-surface p-5">
              ...
              <Link
                ...
                className={`mt-2 inline-flex h-10 w-full items-center justify-center gap-2 rounded-xl border border-td-accent/20 bg-td-accent/[0.055] text-[11px] font-semibold text-td-accent-text transition hover:border-td-accent/35 hover:bg-td-accent/[0.09] ${lines.length ? "" : "pointer-events-none opacity-40"}`}
