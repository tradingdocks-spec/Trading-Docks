...
export const SELLING_NAV: NavigationSection = {
  ...
  children: [
    { href: "/dashboard/selling", label: "Selling overview", icon: CircleDollarSign },
    { href: "/dashboard/selling/listings", label: "Listing workstation", icon: ClipboardList },
    { href: "/dashboard/selling/pricing", label: "Pricing", icon: Percent },
    { href: "/dashboard/selling/connections", label: "Connections", icon: PlugZap },
    { href: "/dashboard/selling/pick-pack", label: "Pick & Pack", icon: PackageCheck },
...
const ADMIN_NAV: NavigationItem[] = [
  ...
  { href: "/dashboard/admin/marketing/autopilot", label: "Marketing Autopilot", icon: BrainCircuit },
