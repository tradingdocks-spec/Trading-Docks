...
export function Sidebar({
  ...
  return (
    <>
      ...
      <aside
        className={[
          "fixed inset-y-0 left-0 z-50 flex w-[264px] flex-col border-r border-white/[0.06] bg-[#071017]/95 shadow-[24px_0_70px_rgba(0,0,0,0.24)] backdrop-blur-2xl transition-[width,transform] duration-300 ease-out",
