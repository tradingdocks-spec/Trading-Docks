  ...
  return (
    <div className="desktop_layout tablet_layout mobile_layout min-h-screen bg-[radial-gradient(circle_at_50%_-10%,rgba(15,75,94,.2),transparent_32%),#02090f] text-white">
      ...
      <Link
        ...
        className="fixed bottom-5 right-5 z-30 hidden h-12 items-center justify-center rounded-full border border-cyan-300/30 bg-cyan-400 px-4 text-xs font-bold text-[#021018] shadow-[0_10px_28px_rgba(6,182,212,.2)] transition hover:-translate-y-0.5 hover:bg-cyan-300 md:flex md:w-auto md:gap-2"
      >
