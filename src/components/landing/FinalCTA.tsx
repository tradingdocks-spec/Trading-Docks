...
export function FinalCTA() {
  return (
    <section className="relative z-10 mx-auto w-full max-w-[1480px] px-4 pb-20 sm:px-8 sm:pb-24 lg:px-12 lg:pb-32">
      <div className="relative overflow-hidden rounded-[26px] border border-cyan-300/[0.18] bg-[#061522] px-5 py-10 shadow-[0_35px_120px_rgba(0,0,0,0.44)] sm:rounded-[34px] sm:px-10 sm:py-12 lg:px-14 lg:py-16">
