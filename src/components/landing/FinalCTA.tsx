...
export function FinalCTA() {
  return (
    <section className="relative z-10 mx-auto w-full max-w-[1480px] px-5 pb-24 sm:px-8 lg:px-12 lg:pb-32">
      <div className="relative overflow-hidden rounded-[34px] border border-cyan-300/[0.18] bg-[#061522] px-7 py-12 shadow-[0_35px_120px_rgba(0,0,0,0.44)] sm:px-10 lg:px-14 lg:py-16">
        ...
        <div className="relative grid gap-10 lg:grid-cols-[1fr_auto] lg:items-center">
          ...
          <TransitionLink
            ...
            className="primary-button group relative inline-flex h-13 items-center justify-center gap-3 overflow-hidden rounded-2xl px-7 text-sm font-semibold text-[#00131a]"
          >
