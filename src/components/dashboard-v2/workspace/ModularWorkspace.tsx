...
const STORAGE_KEY = "trading-docks-dashboard-v2-layouts";
...
export function ModularWorkspace() {
  ...
  useEffect(() => {
    ...
    try {
      setLayouts({ ...DEFAULT_LAYOUTS, ...JSON.parse(stored) });
    } catch {
    ...
    <WorkspaceFrame>
      <header className={`${styles.glassPanel} rounded-[28px] p-4 sm:p-6`}>
        <div className="flex flex-col gap-4 sm:gap-5 xl:flex-row xl:items-end xl:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-500 sm:mt-3 sm:leading-7">
              Add, remove, resize, and reorder modules. Switch layouts for different
              workflows without leaving the dashboard.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-2 sm:flex sm:flex-wrap sm:items-center">
            ...
            <button
              ...
              className={[
                "inline-flex h-11 items-center justify-center gap-2 rounded-xl border px-3 text-xs font-semibold transition sm:px-4",
                editing
            ...
            <button
              ...
              className="inline-flex h-11 items-center justify-center gap-2 rounded-xl border border-white/[0.075] bg-white/[0.025] px-3 text-xs font-semibold text-slate-400 sm:px-4"
            >
            ...
            <button
              type="button"
              onClick={save}
              className="col-span-2 inline-flex h-11 items-center justify-center gap-2 rounded-xl bg-gradient-to-b from-cyan-300 via-cyan-400 to-sky-500 px-4 text-xs font-semibold text-[#001018] sm:col-span-1"
            >
        ...
        <div className="mt-4 flex flex-col gap-3 border-t border-white/[0.06] pt-4 sm:mt-6 sm:pt-5 lg:flex-row lg:items-center lg:justify-between">
          <div className="-mx-1 flex snap-x gap-1 overflow-x-auto px-1 pb-1 sm:flex-wrap sm:gap-2 sm:overflow-visible sm:pb-0">
            {LAYOUTS.map(([id, label]) => (
              <button
                ...
                className={[
                  "inline-flex h-10 shrink-0 snap-start items-center gap-2 rounded-xl border px-4 text-xs font-semibold transition",
                  layoutId === id
...
function WidgetContent({ id }: { id: string }) {
  if (id === "inventory-value") return <Metric value="$482,114" detail="+$3,214 today" />;
  if (id === "inventory-count") return <Metric value="48,821" detail="+248 today · 412 listed" />;
  if (id === "revenue") return <Metric value="$18,421" detail="+18.2% · $612/day" />;
  if (id === "orders") return <List rows={["38 orders today", "14 awaiting shipment", "3 returns open"]} />;
  if (id === "marketplaces") return <List rows={["TCGplayer online", "eBay online", "Mana Pool online"]} />;
  if (id === "listing-queue") return <List rows={["412 ready to list", "38 need pricing", "14 need photos"]} />;
  if (id === "automation") return <List rows={["248 prices updated", "Sync completed 2m ago", "4 alerts generated"]} />;
  if (id === "team") return <List rows={["Alex · Fulfillment", "Morgan · Pricing", "Jeremy · Admin"]} />;
  if (id === "supplies") return <List rows={["Mailers low in 8 days", "Sleeves reorder due", "Labels 42% remaining"]} />;
  ...
  return <Metric value="94%" detail="Healthy · updated moments ago" />;
}
...
function CollectionGrowth() {
  ...
  const rangeData = {
    "7D": [
      { label: "Mon", value: 468120 },
      { label: "Tue", value: 471880 },
      { label: "Wed", value: 469340 },
      { label: "Thu", value: 475920 },
      { label: "Fri", value: 479650 },
      { label: "Sat", value: 481200 },
      { label: "Sun", value: 482114 },
    ],
    "30D": [
      { label: "Jun 25", value: 451200 },
      { label: "Jun 29", value: 456480 },
      { label: "Jul 3", value: 454920 },
      { label: "Jul 7", value: 461750 },
      { label: "Jul 11", value: 465880 },
      { label: "Jul 15", value: 470420 },
      { label: "Jul 19", value: 474950 },
      { label: "Jul 23", value: 479360 },
      { label: "Jul 24", value: 482114 },
    ],
    "90D": [
      { label: "May 1", value: 412600 },
      { label: "May 12", value: 418900 },
      { label: "May 23", value: 426300 },
      { label: "Jun 3", value: 423850 },
      { label: "Jun 14", value: 438200 },
      { label: "Jun 25", value: 451200 },
      { label: "Jul 6", value: 460400 },
      { label: "Jul 17", value: 471500 },
      { label: "Jul 24", value: 482114 },
    ],
    "1Y": [
      { label: "Jan", value: 328400 },
      { label: "Feb", value: 341900 },
      { label: "Mar", value: 337600 },
      { label: "Apr", value: 359800 },
      { label: "May", value: 371200 },
      { label: "Jun", value: 384900 },
      { label: "Jul", value: 397500 },
      { label: "Aug", value: 412300 },
      { label: "Sep", value: 421700 },
      { label: "Oct", value: 446800 },
      { label: "Nov", value: 459200 },
      { label: "Dec", value: 482114 },
    ],
    ALL: [
      { label: "2022", value: 164200 },
      { label: "2023", value: 238900 },
      { label: "2024", value: 312600 },
      { label: "2025", value: 401500 },
      { label: "2026", value: 482114 },
    ],
  } as const;
  ...
  return (
    <div>
      <div className="mb-3 flex items-center justify-between">
        <p className="text-xs font-semibold text-white">July 2026</p>
        <a
      ...
      <div className="grid grid-cols-7 gap-1">
        {Array.from({ length: 31 }, (_, index) => index + 1).map((day) => (
          ...
          >
            ...
            {events[day] ? (
              <span className="mt-1 block truncate rounded bg-cyan-400/[0.07] px-1 py-0.5 text-[5px] text-cyan-200">
                {events[day]}
              </span>
            ) : null}
          </a>
...
function AIRecommendations() {
  return (
    <List
      rows={[
        "List 38 cards with strong demand",
        "Reorder mailers before Friday",
        "Alex has 38 hours scheduled",
        "6 orders require attention",
      ]}
    />
  );
}
